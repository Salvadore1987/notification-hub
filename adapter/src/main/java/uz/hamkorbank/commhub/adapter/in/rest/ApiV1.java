...
public final class ApiV1 {
    ...
    /**
     * Identifies who asks for a batch action, until the OIDC/mTLS identity of SEC-01 is wired.
     *
     * <p>Optional: without it the action is recorded as performed by the system, which is what an
     * unattended source system doing it is.
     */
