...
Состояния `ChannelStatus.MAINTENANCE` и `DISABLED` заводятся кейсом на **отдельном канале сценария**, а не переключением общего: третья ветка `NoRoute` («`channel %s is %s`») иначе сломала бы все параллельные кейсы того же класса.
