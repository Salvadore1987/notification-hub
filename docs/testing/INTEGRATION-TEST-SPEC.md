...
Порядок ручного прогона — в [`TEST-PLAN.md`](TEST-PLAN.md): этапы, профили запуска (четырнадцать кейсов требуют не другого состояния БД, а других свойств приложения) и чекбоксы на все 157 кейсов. Порядком кейсы друг от друга не связаны — см. ниже; план экономит перезапуски и время на разбор, а не создаёт зависимости.
